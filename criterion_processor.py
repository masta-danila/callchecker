...
"evaluation": оценка по шкале от 1 до 100 в рамках промпта. Если в основном ответе ты не нашел никакой информации, то ставь оценку null.  Оценка ставится только в ключе evaluation, в ключе text оценки ставить запрещено.
