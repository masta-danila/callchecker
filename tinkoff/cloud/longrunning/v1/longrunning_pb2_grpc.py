...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in tinkoff/cloud/longrunning/v1/longrunning_pb2_grpc.py depends on'
...
def add_OperationsServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('tinkoff.cloud.longrunning.v1.Operations', rpc_method_handlers)
